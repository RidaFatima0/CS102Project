...
public class konyaSearchMainMenu extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {

    EditText search;
    ImageView searchicon, displayimage, filter, bookmark1, notification, profile, applogo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_konya_search_main_menu);
        ...
        bookmark1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(konyaSearchMainMenu.this, "Listing added to saved list.", Toast.LENGTH_LONG).show();
        ...
        searchicon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (search.getText().toString().equals("Ankara")){
                    Intent intent = new Intent(getApplicationContext(), MainMenuSearchedLoggedIn.class);
                    startActivity(intent);
                    finish();
                }
            }
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popup = new PopupMenu(konyaSearchMainMenu.this, profile);
                popup.setOnMenuItemClickListener(konyaSearchMainMenu.this);
