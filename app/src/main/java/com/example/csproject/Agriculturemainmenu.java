...
public class Agriculturemainmenu extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agriculturemainmenu);
        ...
        bookmark1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Agriculturemainmenu.this, "Listing added to saved list.", Toast.LENGTH_LONG).show();
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popup = new PopupMenu(Agriculturemainmenu.this, profile);
                popup.setOnMenuItemClickListener(Agriculturemainmenu.this);
